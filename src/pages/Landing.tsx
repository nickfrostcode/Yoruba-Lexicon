...
export const Landing: React.FC = () => {
	return (
		<div className='overflow-hidden'>
			{/* Hero Section */}
			<section className='relative pt-20 pb-32 md:pt-32 md:pb-48 hero-bg'>
				<div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10'>
					<div className='text-center'>
						<motion.div
							...
							className='inline-block px-4 py-1.5 mb-6 rounded-full bg-brand-cream/10 text-brand-cream text-sm font-bold uppercase tracking-widest'
						>
							The Living Archive
						</motion.div>
						<motion.h1
							...
							className='text-5xl md:text-8xl font-serif font-bold tracking-tight text-brand-cream mb-8 leading-[0.9]'
						>
							Preserving the <br />
						...
						<motion.p
							...
							className='max-w-2xl mx-auto text-xl text-brand-cream/60 mb-12 leading-relaxed'
						>
						...
						<div className='relative'>
							<div className='aspect-square rounded-2xl bg-brand-cream/5 border border-brand-cream/10 p-8 flex items-center justify-center'>
								<div className='text-center'>
									<Book
										size={120}
										className='text-brand-orange/20 mb-8 mx-auto'
									/>
			...
			<section className='py-32'>
				<div className='max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center'>
					...
					<p className='text-xl text-brand-ink/60 mb-12'>
						Join our community of linguists and speakers to help document
						the Yorùbá language.
					</p>
